...
if __name__ == "__main__":
    ...
    suite.addTests(loader.loadTestsFromTestCase(TestDynamicEPLBSimple))
    suite.addTests(loader.loadTestsFromTestCase(TestDynamicEPLBMultiChunk))
