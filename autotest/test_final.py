...
class _BaseTestDynamicEPLB(CustomTestCase):
    ...
    def setUpClass(cls):
        ...
        if is_npu():
            cls.model = (
                #"/root/.cache/modelscope/hub/models/deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct/"
                "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct/"
            )
...
class TestStaticEPLB(CustomTestCase):
    def test_save_expert_distribution_and_init_expert_location(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            if is_npu():
                engine_kwargs = dict(
                    model_path="/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct/",
                ...
                engine_kwargs = dict(
                    model_path="/root/.cache/modelscope/hub/models/vllm-ascend/DeepSeek-R1-W8A8",
                    trust_remote_code=True,
                    ep_num_redundant_experts=4,
                    enable_dp_attention=True,
                    moe_a2a_backend="deepep",
